# C3DC term endpoint verification report
...
**Input:** `c3dc_enum_terms_for_verification_enriched.csv`
...
**Full results:** `c3dc_term_endpoint_verification_report.csv`
