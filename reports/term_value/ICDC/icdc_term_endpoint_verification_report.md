# ICDC term endpoint verification report
...
**Input:** `icdc_enum_terms_for_verification_enriched.csv`
...
**Full results:** `icdc_term_endpoint_verification_report.csv`
