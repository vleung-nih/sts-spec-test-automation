...
| `CADSR_BASE_URL` | Root URL for the caDSR REST API (manual test `test_cadsr_alternate_values_cdepvs_modelpvs.py` only; paths like `/DataElement/{publicId}`) | `https://cadsrapi.cancer.gov/rad/NCIAPI/1.0/api` |
